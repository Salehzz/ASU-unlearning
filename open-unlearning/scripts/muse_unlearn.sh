...
for retain_loss in "${retain_losses[@]}"; do
    for data_split in "${data_splits[@]}"; do
        for trainer in "${trainers[@]}"; do
            ...
            trainer.method_args.retain_loss_type=${retain_loss}
...
for retain_loss in "${retain_losses[@]}"; do
    for trainer in "${trainers[@]}"; do
        ...
        trainer.args.gradient_checkpointing=true \
        trainer.method_args.retain_loss_type=${retain_loss} \
        trainer.method_args.alpha="0.35" \
        trainer.method_args.attention_temp="2.0"
...
for retain_loss in "${retain_losses[@]}"; do
    for trainer in "${trainers[@]}"; do
        ...
        trainer.args.gradient_checkpointing=true \
        trainer.method_args.retain_loss_type=${retain_loss} \
        trainer.method_args.alpha="0.001" \
        trainer.method_args.attention_temp="2.35"
